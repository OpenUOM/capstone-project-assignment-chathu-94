...
const addTeacher = async (id, name, age) => {
    ...
    return new Promise((resolve, reject) => {
        knex_db
            .raw(sql,[id,name,age])
            .then(() => {
                resolve({status: "Succesfully inserted Teacher"});
            })
            .catch((error) => {
                reject(error);
            });
...
const updateTeacher = async (name, age, id) => {
    ...
    return new Promise((resolve, reject) => {
        knex_db
            .raw(sql,[name,age,id])
            .then(() => {
                resolve({status: "Succesfully updated Teacher"});
            })
            .catch((error) => {
                reject(error);
            });
...
const deleteTeacher = async (id) => {
    ...
    return new Promise((resolve, reject) => {
        knex_db
            .raw(sql,[id])
            .then(() => {
                resolve({status: "Succesfully deleted Teacher"});
            })
            .catch((error) => {
                reject(error);
            });
...
const addStudent = async (id, name, age, hometown) => {
    ...
    return new Promise((resolve, reject) => {
        knex_db
            ...
            .then(() => {
                resolve({status: "Succesfully inserted Student"});
            })
            .catch((error) => {
                reject(error);
            });
...
const updateStudent = async (name, age, hometown, id) => {
    ...
    return new Promise((resolve, reject) => {
        knex_db
            ...
            .then(() => {
                resolve({status: "Succesfully updated Student"});
            })
            .catch((error) => {
                reject(error);
            });
...
const deleteStudent = async (id) => {
    ...
    return new Promise((resolve, reject) => {
        knex_db
            .raw(sql,[id])
            .then(() => {
                resolve({status: "Succesfully deleted Student"});
            })
            .catch((error) => {
                reject(error);
            });
